...
nets = dict(
    ...
    hirocoin=math.Object(
        ...
        BLOCK_PERIOD=60, # s
        SYMBOL='HIRO',
        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Hirocoin') if platform.system() == 'Windows' 
						else os.path.expanduser('~/Library/Application Support/Hirocoin/') if platform.system() == 'Darwin' 
						else os.path.expanduser('/home/administrator/.hirocoin'), 'hirocoin.conf'),
	...
	darkcoin=math.Object(
        ...
        BLOCK_PERIOD=150, # s
        SYMBOL='DRK',
        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Darkcoin') if platform.system() == 'Windows' 
						else os.path.expanduser('~/Library/Application Support/Darkcoin/') if platform.system() == 'Darwin' 
						else os.path.expanduser('/home/administrator/.darkcoin'), 'darkcoin.conf'),
